...
public class GenerateNumberFiles {
	...
	public static void main(String[] args) {
		 ...
		 */		
		final String TEMP_LOCATION = "YOUR-TEMP-LOCATION";
		
		System.out.println("Creating first file");
		createNumberFile(TEMP_LOCATION + "records1.txt", 500000, 100);
		System.out.println("First file completed");
		System.out.println("Creating second file");
		createNumberFile(TEMP_LOCATION + "records2.txt", 400000, 150);
