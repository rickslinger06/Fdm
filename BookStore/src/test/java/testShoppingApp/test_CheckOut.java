...
//	
//	@Test
//	void test_How_many_sameBookInBasket() {
//		Book book = new Book("book",12.00);
//		basket.addBook(book);
//		basket.addBook(book);
//		basket.addBook(book);
//		basket.addBook(new Book("book5",25.00));
//		int NumberOfsameBook = checkout.gettotal_SameBookInBasket(basket);
//		assertEquals(3, NumberOfsameBook);
//		
//	}
//
//
